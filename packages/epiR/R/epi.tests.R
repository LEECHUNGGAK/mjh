...
print.epi.tests <- function(x, decimal_place = 4, ...) {
    ...
    with(x$rval, {
        ...
        cat(sprintf(stringr::str_replace_all("\nApparent prevalence                    %.2f (%.2f, %.2f)",
                                             "\\d",
                                             as.character(decimal_place)),
                    aprev$est,
                    aprev$lower,
                    aprev$upper
                    ))
